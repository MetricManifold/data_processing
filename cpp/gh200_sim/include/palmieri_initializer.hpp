...
// Accepted coordinates are narrowed to binary32 immediately. Later candidate
// tests use those stored binary32 centres. This rounding point is part of the
// method identifier and is locked by the whole-table golden tests.
...
// FNV-1a over canonical little-endian IEEE-754 words in accepted order:
// x[0], y[0], x[1], y[1], ... . SHA-256 remains the archival file digest;
// this compact value lets the simulator and CPU tests identify loaded bits.
