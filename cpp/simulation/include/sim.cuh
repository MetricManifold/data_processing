...
struct Simulation {
    ...
    void sync_pool_to_parity() {
        ...
        // S / volumes / Ix / Iy are double-buffered. Refresh the
        // single-buffer aliases to point at the parity-current halves so
        // downstream code (trajectory writer, rebind, VTK, ...) that reads
        // cells.S / cells.volumes / cells.Ix / cells.Iy gets the most
        // recently produced moment set.
